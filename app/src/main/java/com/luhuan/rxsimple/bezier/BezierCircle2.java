...
public class BezierCircle2 extends View {
    ...
    public BezierCircle2(Context context) {
        super(context);
        init();
    }

    public BezierCircle2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BezierCircle2(Context context, AttributeSet attrs, int defStyleAttr) {
